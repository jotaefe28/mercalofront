...
export class SecurityHeadersService {
  ...
  static getSecurityHeaders(): Record<string, string> {
    return {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' "
    };
  }
}
